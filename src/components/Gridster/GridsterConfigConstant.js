import { CompactType, DirTypes, DisplayGrid, GridType } from './GridsterConfig.js'

/**
 *
 * @type {{displayGrid: *, outerMargin: boolean, minCols: number, itemInitCallback: undefined, maxLayerIndex: number, scrollSpeed: number, maxItemArea: number, minItemRows: number, emptyCellDragMaxCols: number, enableEmptyCellDrag: boolean, maxRows: number, useTransformPositioning: boolean, disablePushOnResize: boolean, minRows: number, margin: number, rowHeightRatio: number, swap: boolean, outerMarginLeft: null, defaultItemRows: number, outerMarginTop: null, enableEmptyCellContextMenu: boolean, enableOccupiedCellDrop: boolean, scrollToNewItems: boolean, initCallback: undefined, keepFixedHeightInMobile: boolean, outerMarginBottom: null, mobileBreakpoint: number, defaultLayerIndex: number, disableWarnings: boolean, swapWhileDragging: boolean, disableScrollVertical: boolean, keepFixedWidthInMobile: boolean, itemResizeCallback: undefined, fixedColWidth: number, maxCols: number, pushItems: boolean, emptyCellClickCallback: undefined, maxItemRows: number, disableWindowResize: boolean, defaultItemCols: number, outerMarginRight: null, emptyCellDragCallback: undefined, scale: number, allowMultiLayer: boolean, itemChangeCallback: undefined, scrollSensitivity: number, disableAutoPositionOnConflict: boolean, draggable: {delayStart: number, dropOverItemsCallback: undefined, ignoreContentClass: string, ignoreContent: boolean, dragHandleClass: string, stop: undefined, start: undefined, dropOverItems: boolean, enabled: boolean}, gridType: string, itemRemovedCallback: undefined, minItemArea: number, compactType: Level.None, pushDirections: {east: boolean, south: boolean, north: boolean, west: boolean}, maxItemCols: number, emptyCellContextMenuCallback: undefined, disableScrollHorizontal: boolean, resizable: {handles: {se: boolean, s: boolean, sw: boolean, e: boolean, w: boolean, ne: boolean, nw: boolean, n: boolean}, delayStart: number, stop: undefined, start: undefined, enabled: boolean}, baseLayerIndex: number, gridSizeChangedCallback: undefined, enableEmptyCellDrop: boolean, dirType: string, setGridSize: boolean, emptyCellDropCallback: undefined, fixedRowHeight: number, destroyCallback: undefined, minItemCols: number, emptyCellDragMaxRows: number, disablePushOnDrag: boolean, pushResizeItems: boolean, enableEmptyCellClick: boolean, ignoreMarginInRow: boolean, itemValidateCallback: undefined}}
 */
